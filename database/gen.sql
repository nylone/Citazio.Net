...
CREATE OR REPLACE PROCEDURE ADD_BOARD(IN NAME VARCHAR(25), IN PATH VARCHAR(25), IN ADMIN_ID BIGINT UNSIGNED, IN ACCESS_LVL BIT(2))
BEGIN
    INSERT INTO BOARDS(ADMIN_ID, PATH, NAME, ACCESS_LVL) VALUE (ADMIN_ID, PATH, NAME, ACCESS_LVL);
