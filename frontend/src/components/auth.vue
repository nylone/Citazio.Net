    ...
    <div class="theysa-flex-row">
        <div class="theysa-flex-col theysa-box theysa-shadow grows">
            ...
            <form action="javascript:void(0);" class="theysa-flex-col">
                <input class="theysa-shadow grows" id="luser" placeholder="username" required
                    v-on:input="check_input('luser')" type="text" /><br />
                <input class="theysa-shadow grows" id="lpass" placeholder="password" required type="password" /><br />
        ...
        <div class="theysa-flex-col theysa-box theysa-shadow grows">
            ...
            <form action="javascript:void(0);" class="theysa-flex-col">
                ...
                <input class="theysa-shadow grows" placeholder="username" id="suser" required
                    v-on:input="check_input('suser')" type="text" /><br />
                <input class="theysa-shadow grows" placeholder="password" id="spass" required type="password" /><br />
                <input class="theysa-shadow grows" id="cpass" placeholder="confirm password" required v-on:input="verify()"
                    type="password" /><br />

                <input v-if="showToken" class="theysa-shadow grows" id="token" placeholder="Token" required type="text" />
